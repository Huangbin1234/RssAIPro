...
public class Feed extends WireFeed {
    ...
    /**
     * Sets the feed copyright (Atom 0.3, maps to {@link #setRights(String)}).
     * <p>
     *
    ...
    /**
     * Sets the feed modified date (Atom 0.3, maps to {@link #setUpdated(Date)}).
     * <p>
     *
