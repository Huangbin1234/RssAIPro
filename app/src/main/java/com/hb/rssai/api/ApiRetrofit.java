...
//    public static final String BASE_URL = "http://192.168.0.105:8088/";
//    public static final String ROOT_URL = "http://192.168.0.116:8088/";
    public static final String ROOT_URL = "http://118.24.53.146:8088/";
    public static final String BASE_URL = ROOT_URL + "zr/";
    public static final String JSON_URL = ROOT_URL + "app_update/checkvercode.json";//此处修改你的json文件地址
