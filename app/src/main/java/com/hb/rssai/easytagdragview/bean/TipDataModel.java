package com.hb.rssai.easytagdragview.bean;
...
public class TipDataModel {
    private static String[] dragTips ={"头条","热点","娱乐","体育","财经","科技","段子","轻松","军事","历史","游戏","时尚","NBA"
            ,"漫画","社会","足球","手机"};
    private static String[] addTips ={"数码","移动","云课堂","家居","旅游","健康","读书","跑步","情感","政务","艺术","博客"};
